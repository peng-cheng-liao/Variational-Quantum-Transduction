...
statetype= "_GKP_code_states_"
Nt = 20
delta = torch.tensor(0.32)
kappa = torch.tensor(0.32)
d = 2
l0 = GKP_state_approx(0, delta, kappa, d, Nt, slimit=5, type_torch=True)
l1 = GKP_state_approx(1, delta, kappa, d, Nt, slimit=5, type_torch=True)
state_signals = [l0,l1]
...
def target(x):
    ef, n1_input0, state_in0 = transduction_protocol_ECD_MM_EF(state_signals, theta, x, depth, Nt)
    fidelity = ef
