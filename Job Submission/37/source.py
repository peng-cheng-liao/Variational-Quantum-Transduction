...
statetype = "_CoherentInfo_EA_test1_"
Nt = 30
...
def target(x):
    CI, ns_input, np_input, state_RS, state_PA = transduction_protocol_CoherentInfo_ECD_MM_EA_test1(np_constraint, eta, x, depth, Nt)
    loss = (-CI +
